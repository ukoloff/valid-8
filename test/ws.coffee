...
describe 'isValidUTF8', ->
  ...
  it 'should return true for valid cases from the autobahn test suite', ->
    assert valid8 new Buffer '\xf0\x90\x80\x80'
    assert valid8 new Buffer [0xf0, 0x90, 0x80, 0x80]

  it 'should return false for erroneous autobahn strings', ->
    assert not valid8 new Buffer [0xce, 0xba, 0xe1, 0xbd]
